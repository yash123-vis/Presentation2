...
public class DiseaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (max == c[6]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d7));
            ...
            info[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW);
                    browserIntent.setData(Uri.parse("https://www.google.com/search?q=asthma&sca_esv=558490629&sxsrf=AB5stBgRX0sfekQZ6_hBHOt9OTLy2nxvIw%3A1692508215358&ei=N6DhZPjBFYT7wAPYg5pI&oq=asth&gs_lp=&sclient=gws-wiz-serp"));
                    startActivity(browserIntent);
                }
            });
        ...
        if (max == c[7]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d8));
            ...
            info[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW);
                    browserIntent.setData(Uri.parse("https://www.google.com/search?q=common+cold&sca_esv=558490629&sxsrf=AB5stBikL_5vJLs3w5RPxkH0LZCv_1kRBA%3A1692505457842&ei=cZXhZJ7wMpPW1e8P1K-h4Ak&oq=common&gs_lp=Egxnd3Mtd2l6LXNlcnAiBmNvbW1vbioCCAAyChAAGIoFGLEDGEMyChAAGIoFGLEDGEMyChAAGIoFGLEDGEMyBxAAGIoFGEMyBxAAGIoFGEMyChAAGIoFGLEDGEMyCBAAGIAEGLEDMgsQABiKBRixAxiDATIIEAAYgAQYsQMyCBAAGIAEGLEDSME6ULYcWNcvcAN4AZABAJgB_&sclient=gws-wiz-serp#cobssid=s"));
                    startActivity(browserIntent);
                }
            });
